...
export class RegisterComponent implements OnInit {
	...
	validate(f: NgForm) {
		...
		if (objectPath.get(f, 'form.controls.cellphone.errors.minlength')) {
			this.errors.push(this.translate.instant('AUTH.VALIDATION.INVALID', { name: this.translate.instant('AUTH.INPUT.CELLPHONE'), min: 11 }));
		}
		if (objectPath.get(f, 'form.controls.cellphone.errors.required')) {
